...
### ⚙️ Full-Stack & API Systems

I specialize in **API-first architectures** built with **Next.js**, **Node.js**, and **TypeScript**, ensuring scalable and observable data flow between services.
Deployments often pair **Vercel**, **Neon Postgres**, and **Drizzle ORM**, providing seamless schema versioning, efficient query performance, and well-defined separation between logic and presentation.
...
### 🧠 AI, ML, and Multimodal Reasoning

I build advanced frameworks around **large-language-model integration**, **embedding pipelines**, and **context-aware orchestration**.
Proficient with the **AI SDK** (Anthropic, xAI, and OpenAI), I design streaming chat systems and real-time reasoning layers that support rich, adaptive conversation.
